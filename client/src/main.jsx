...
function App(){
 ...
 async function checkout(id){
  ...
  try{const r=await fetch('/api/create-checkout-session',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({plan:id})}); const d=await r.json(); if(!r.ok) throw Error(d.error); location.href=d.url;}
